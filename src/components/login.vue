...
.other-login a {
    ...
    vertical-align: top;
    margin-right: 10px;
    background: url(../../static/images/login/other-login-bg.png) center
        no-repeat;
...
.unslider-arrow.prev {
    left: 0;
    background: url(../../static/images/login/slide_l.png) no-repeat center
        center;
}
...
.unslider-arrow.next {
    right: 0;
    background: url(../../static/images/login/slide_r.png) no-repeat center
        center;
}
