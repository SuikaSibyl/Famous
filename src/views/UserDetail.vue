<template>
    <el-container>
        <el-container style="height: 98vh;">
            <HeadBar current="my" title="我的收藏"></HeadBar>
            <el-container>
                ...
                <el-main>
                    ...
                    <div class="search-wrap">
                        <div
                            v-for="(item, index) in favPeople"
                            class="search-card"
                            :key="item.famouspeople.id"
                        >
                            <div class="search-block">
                                <el-button
                                    style="padding: 5px; right: 44px;"
                                    type="primary"
                                    icon="el-icon-info"
                                    circle
                                    @click="gotoPeople(item.famouspeople.id)"
                                ></el-button>
                                <el-button
                                    style="padding: 5px;"
                                    @click="
                                        deletePeople(
                                            item.famouspeople.id,
                                            index
                                        )
                                    "
                                    type="danger"
                                ...
                                <div>
                                    <span class="tags">{{
                                        item.famouspeople.major
                                    }}</span
                                    ><span
                                        style="font-size: 24px; margin-left: 5px;"
                                        >{{ item.famouspeople.name }}</span
                                    >
                                </div>
                                <div style="font-size: 16px; margin-top: 5px;">
                                    {{ item.famouspeople.birthplace }}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            <div class="search-block">
                                <el-button
                                    ...
                                    icon="el-icon-info"
                                    circle
                                    @click="gotoPeople(item.works.author.id)"
                                ></el-button>
                                <el-button
                                    style="padding: 5px;"
