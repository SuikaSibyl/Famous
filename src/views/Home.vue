        ...
        <el-main class="elmain"
            ...
            <div class="row-wrap"
              ...
              <div v-for="item in result"
                ...
                <div class="search-block">
                  <el-button style="padding: 5px; right: 10px;"
                             type="primary"
                             icon="el-icon-info"
                             circle
                  ...
                  <div>
                    <span class="tags">{{
                                            item.major
                                        }}</span><span style="font-size: 24px; margin-left: 5px;">{{ item.name }}</span>
                  </div>
          ...
          <div class="card image-search-bar">
            <div style="font-size: 18px; color: #409EFF;">
              <el-tag effect="plain"
                      size="small">AI识图</el-tag>寻找您的文化气质
            </div>
...
export default {
  ...
  methods: {
    ...
    async add() {
      ...
      var image = document.getElementById('file1').files[0] //所以在这里会找不到
      console.log(image)
      ...
      if(!res) {
        ...
        this.$message('连接服务失败，请小主下次再光顾吧>_<')
        that.dialogClose()
        return
      }
