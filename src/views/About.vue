          ...
          <div class="column-wrap"
            ...
            <div class="row-wrap margin-bottom">
              <div class="avatar-wrap"
                ...
                <el-image style="max-width: 180px; max-height: 240px;"
                :src="url"
              ...
              <div class="column-wrap margin-bottom">
                <div class="row-wrap">
                  ...
                  <div style="line-height: 40px; color: gray; margin-left: 4px;">
                    ({{ gender }})
                  </div>
                </div>
                <div>
                ...
                <div>
                  <span class="text-blue text-bold">出生地：</span>{{ birthplace }}
                </div>
                <div>
                  <span class="text-blue text-bold">专业：</span>{{ major }}
                </div>
                <div>
                  <span class="text-blue text-bold">国籍：</span>{{ nationality }}
                </div>
                <div>
                  <span class="text-blue text-bold">毕业院校：</span>{{ academy }}
                </div>
              </div>
            </div>
